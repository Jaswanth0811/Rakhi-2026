      ...
      <AnimatePresence mode="wait">
        ...
        {letterState === "sealed" || letterState === "breaking_seal" ? (
          ...
          >
            ...
            {letterState === "sealed" && (
              <div className="relative w-full aspect-[4/3] rounded-2xl bg-gradient-to-b from-[#FEF3C7] to-[#FDE68A] border-2 border-amber-300/80 p-4 shadow-inner flex flex-col items-center justify-center overflow-hidden my-1">
